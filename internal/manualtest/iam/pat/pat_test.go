...
// 手动运行:
//
//	MANUAL=1 go test -v -run TestPATFlow ./internal/integration/pat/
...
// 手动运行:
//
//	MANUAL=1 go test -v -run TestListPATs ./internal/integration/pat/
...
// 手动运行:
//
//	MANUAL=1 go test -v -run TestPATWithScopes ./internal/integration/pat/
...
// 手动运行:
//
//	MANUAL=1 go test -v -run TestListPATScopes ./internal/integration/pat/
...
// 手动运行:
//
//	MANUAL=1 go test -v -run TestPATScopeEnforcement ./internal/integration/pat/
...
// 手动运行:
//
//	MANUAL=1 go test -v -run TestPATFullScopeAccess ./internal/integration/pat/
...
// 手动运行:
//
//	MANUAL=1 go test -v -run TestPATScopeWithRegularUser ./internal/integration/pat/
