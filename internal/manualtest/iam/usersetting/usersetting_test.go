...
func TestListSettings(t *testing.T) {
	...
	t.Run("登录用户可获取设置列表", func(t *testing.T) {
		result, _, err := manualtest.GetList[userset.UserSettingDTO](
			c,
			"/api/user/settings",
			nil,
		)
...
func TestGetSetting(t *testing.T) {
	...
	t.Run("获取存在的设置", func(t *testing.T) {
		...
		result, err := manualtest.Get[userset.UserSettingDTO](
			c,
...
func TestUpdateSetting(t *testing.T) {
	...
	t.Run("更新设置创建自定义值", func(t *testing.T) {
		...
		result, err := manualtest.Put[userset.UserSettingDTO](
			c,
		...
		// 验证更新后的值
		getResult, err := manualtest.Get[userset.UserSettingDTO](
			c,
			"/api/user/settings/"+testKey,
			nil,
		)
	...
	t.Run("验证自定义值覆盖系统默认值", func(t *testing.T) {
		// 先获取原始值
		original, err := manualtest.Get[userset.UserSettingDTO](
			c,
		...
		_, err = manualtest.Put[userset.UserSettingDTO](
			c,
			"/api/user/settings/general.language",
			updateReq,
		)
		...
		// 验证自定义值
		updated, err := manualtest.Get[userset.UserSettingDTO](
			c,
			"/api/user/settings/general.language",
			nil,
		)
...
func TestDeleteSetting(t *testing.T) {
	...
	t.Run("删除自定义值恢复系统默认", func(t *testing.T) {
		...
		// 验证自定义值存在
		customResult, err := manualtest.Get[userset.UserSettingDTO](
			c,
			"/api/user/settings/"+testKey,
			nil,
		)
		...
		// 验证恢复为系统默认值
		defaultResult, err := manualtest.Get[userset.UserSettingDTO](
			c,
			"/api/user/settings/"+testKey,
			nil,
		)
...
func TestSettingsIsolation(t *testing.T) {
	...
	t.Run("不同用户的自定义值应独立", func(t *testing.T) {
		...
		// 验证 Admin 的值
		adminResult, err := manualtest.Get[userset.UserSettingDTO](
			adminClient,
			"/api/user/settings/"+testKey,
			nil,
		)
		...
		// 验证测试用户的值
		testUserResult, err := manualtest.Get[userset.UserSettingDTO](
			testUserClient,
			"/api/user/settings/"+testKey,
			nil,
		)
