...
//	)
//
// 每个 Handler 对应一个或多个 HTTP 端点，路由定义见 [routes](github.com/lwmacct/260103-ddd-bc-iam/pkg/modules/settings/adapters/gin/routes) 包。
//
// # Thread Safety
//
...
// # 依赖关系
//
// 本包依赖 Application 层的 UseCase（见 [app](github.com/lwmacct/260103-ddd-bc-iam/pkg/modules/settings/app)），
