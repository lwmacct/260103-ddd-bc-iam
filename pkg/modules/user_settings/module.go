...
import (
	...
	"github.com/lwmacct/260103-ddd-bc-iam/pkg/modules/user_settings/adapters/gin/handler"
	"github.com/lwmacct/260103-ddd-bc-iam/pkg/modules/user_settings/app"
	"github.com/lwmacct/260103-ddd-bc-iam/pkg/modules/user_settings/infra/cache"
	"github.com/lwmacct/260103-ddd-bc-iam/pkg/modules/user_settings/infra/persistence"
)

// Module 返回 User Settings BC 的 Fx 模块
func Module() fx.Option {
	return fx.Module("user_settings",
		cache.CacheModule,
